...
CGO_ENABLED=1 GOOS=darwin go build -buildmode=c-archive -o ./releases_latest/_scheduller_darwin_amd64.so ./*.go
...
CGO_ENABLED=1 GOOS=linux GOARCH=amd64 CC=x86_64-linux-musl-gcc  CXX=x86_64-linux-musl-g++ go build -buildmode=c-archive -o ./releases_latest/_scheduller_linux_amd64.so ./*.go
...
CGO_ENABLED=1 GOOS=windows GOARCH=386 CC=i686-w64-mingw32-gcc go build -buildmode=c-archive -o ./releases_latest/_scheduller_windows_amd64.dll ./*.go
